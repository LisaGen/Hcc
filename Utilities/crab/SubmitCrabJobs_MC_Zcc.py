...
def parseOptions():
    ...
    parser.add_option('-d', '--datasets', dest='DATASETS', type='string', default='/afs/cern.ch/user/l/lgeneros/Hcc-studies-lxp8/CMSSW_13_0_13/src/Hcc/Utilities/crab/dataset_MC_Zcc.txt', help='txt file with datasets to run over')
    parser.add_option('-c', '--cfg', dest='CONFIGFILE', type='string', default='/afs/cern.ch/user/l/lgeneros/Hcc-studies-lxp8/CMSSW_13_0_13/src/Hcc/HccAna/python/crab/crabConfig_TEMPLATE_MCZcc.py', help='configuration template')
