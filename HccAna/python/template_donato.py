...
'/store/data/Run2023D/JetMET0/MINIAOD/19Dec2023-v1/50000/8b9fa394-ccc8-4428-850b-a0c24e50778f.root',
)
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("Data_2023D.root")
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           #for hpc
                           #CondDB.clone(connect = cms.string("sqlite_file:" +os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23BPixPrompt23_RunD_V1_DATA.db")),
                           #for crab
                           #CondDB.clone(connect = cms.string("sqlite_file:src/Hcc/HccAna/data/Summer23BPixPrompt23_RunD_V1_DATA.db")),
                           CondDB.clone(connect = cms.string("sqlite_file:Summer23BPixPrompt23_RunD_V1_DATA.db")),
                           toGet =  cms.VPSet(
                              cms.PSet(
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer23BPixPrompt23_RunD_V1_DATA_AK8PFPuppi"),
